...
import IEventSchedule from "../models/eventSchedule.model"

const eventScheduleCollection = db.collection(`/eventSchedules/`).withConverter(converter<IEventSchedule>())
