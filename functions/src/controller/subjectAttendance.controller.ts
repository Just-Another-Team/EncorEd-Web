...
import ISubjectAttendance from "../models/subjectAttendance.model"

const subjectAttendanceCollection = db.collection(`/subjectAttendances/`).withConverter(converter<ISubjectAttendance>())
